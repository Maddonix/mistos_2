...
async def new_experiment_group_by_id(new_experiment_group_request: NewExperimentGroupRequest):
    ...
    db_experiment = crud.read_experiment_by_uid(new_experiment_group_request.experiment_id)
    int_experiment = db_experiment.to_int_class()
    print(int_experiment)
    int_experiment.add_experiment_group("NEW EXPERIMENT GROUP") #Maybe implement name from frontend
...
async def delete_experiment_group_by_id(delete_experiment_group_request: DeleteExperimentGroupRequest):
    ...
    db_experiment = crud.read_experiment_by_uid(delete_experiment_group_request.experiment_id)
    db_experiment.delete_experiment_group(delete_experiment_group_request.group_id)
...
async def delete_experiment_by_id(delete_experiment_request: DeleteExperimentRequest):
    ...
    '''
    print("api experiments_delete experiment group")
    db_experiment = crud.read_experiment_by_uid(delete_experiment_request.experiment_id)
...
async def calculate_experiment_results(calculate_results_request: CalculateExperimentResultsRequest):
    ...
    db_experiment = crud.read_experiment_by_uid(calculate_results_request.experiment_id)
    int_experiment = db_experiment.to_int_class()
...
async def update_experiment_description(update_description_request: UpdateDescriptionRequest):
    ...
    db_experiment.update_description(update_description_request.new_description)
...
async def add_result_layer_to_group(add_layer_to_group_request: AddLayerToGroupRequest):
    ...
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(add_layer_to_group_request.group_id)
...
async def update_experiment_group_name(update_name_request: UpdateNameRequest):
    ...
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(update_name_request.id)
...
async def update_experiment_group_hint(update_hint_request: UpdateHintRequest):
    ...
    API Request to update an experiment Hint
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(update_hint_request.id)
...
async def update_experiment_group_description(update_description_request: UpdateDescriptionRequest):
    ...
    API Request to update an experiment description
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(update_description_request.id)
    db_experiment_group.update_description(update_description_request.new_description)
...
async def update_experiment_group_images(update_experiment_group_images_request: UpdateExperimentGroupImagesRequest):
    ...
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(update_experiment_group_images_request.group_id)
    current_images = [image.uid for image in db_experiment_group.images]
    image_id_list = [_id for _id in update_experiment_group_images_request.image_id_list if _id not in current_images]
...
async def delete_image_from_experiment_group(delete_image_from_experiment_group_request: DeleteImageFromExperimentGroupRequest):
    ...
    API Request to update images of an experiment group
    '''
    db_experiment_group = crud.read_experiment_db_group_by_uid(delete_image_from_experiment_group_request.group_id)
    db_experiment_group.remove_image_by_uid(delete_image_from_experiment_group_request.image_id)
