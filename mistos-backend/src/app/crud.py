...
def create_image(image, sess: Session):
    '''
...
def create_result_layer(result_layer, sess: Session):
    '''
...
def create_experiment_group(experiment_group, sess: Session):
    '''
...
def create_experiment_result(experiment_result, sess: Session):
    '''
...
def create_experiment(experiment, sess: Session):
    '''
...
def create_result_measurement(result_measurement, sess: Session):
    '''
...
def create_classifier(classifier, sess: Session):
    '''
...
def read_image_by_uid(uid: int, sess: Session, for_refresh=False):
    '''
...
def read_db_image_by_uid(uid: int, sess: Session):
    '''
...
def read_all_images(sess: Session):
    '''
...
def read_all_classifiers(sess: Session):
    '''
...
def read_db_classifier_by_uid(uid: int, sess: Session):
    '''
...
def read_all_experiments(sess: Session):
    '''
...
def read_experiment_by_uid(uid: int, sess: Session):
    '''
...
def read_experiment_group_by_uid(uid: int, sess: Session, for_refresh=False):
    '''
...
def read_experiment_db_group_by_uid(uid: int, sess: Session):
    '''
...
def read_result_of_experiment_group_by_id(uid: int, sess: Session):
    '''
...
def read_result_layers_of_image_uid(uid: int, sess: Session):
    '''
...
def read_result_layer_by_uid(uid: int, sess: Session):
    '''
...
def read_measurement_by_result_layer_uid(uid: int, sess: Session):
    '''
...
def read_classifier_by_uid(uid: int, sess: Session):
    '''
...
def read_classifier_dict_by_type(clf_type: str, sess: Session):
    '''
...
def update_image_bg_false(uid: int, sess: Session):
    '''
...
def update_image_bg_true(uid: int, layer_uid: int, sess: Session):
    '''
...
def update_image_hint(uid: int, new_hint: str, sess: Session):
    '''
...
def update_experiment_name(uid: int, new_name: str, sess: Session):
    '''
...
def update_experiment_hint(uid: int, new_hint: str, sess: Session):
    '''
...
def update_experiment_description(uid: int, new_description: str, sess: Session):
    '''
...
def update_experiment_group_name(uid: int, new_name: str, sess: Session):
    '''
...
def update_experiment_group_hint(uid: int, new_hint: str, sess: Session):
    '''
    Function expects experiment group id as int and new name as string. Queries db for experiment group and updates the name.
...
def update_experiment_group_description(uid: int, new_description: str, sess: Session):
    '''
...
def update_experiment_group_images(uid: int, image_id_list: List[int], sess: Session):
    '''
...
def add_image_to_experiment_group(experiment_group, image_uid: int, sess: Session):
    '''
...
def add_result_layer_to_experiment_group(experiment_group, result_layer_uid: int, sess: Session):
    '''
...
def add_measurement_to_experiment_group(experiment_group, measurement_uid: int, sess: Session):
    '''
...
def update_result_layer_hint(result_layer_uid: int, new_hint: str, sess: Session):
    '''
    Function expects an int experiment group object and a measurement_uid. Queries db for measurement and adds it to experiment group.
...
def update_result_layer_name(result_layer_uid: int, new_name: str, sess: Session):
    '''
    Function expects an int experiment group object and a measurement_uid. Queries db for measurement and adds it to experiment group.
...
def update_classifier_name(classifier_uid: int, new_name: str, sess: Session):
    '''
    Function expects an int experiment group object and a measurement_uid. Queries db for measurement and adds it to experiment group.
...
def delete_result_layer(db_layer, sess: Session):
    '''
...
def delete_image(db_image, sess: Session):
    '''
    ...
    for layer in db_image.image_result_layers:
        layer.delete()
    q = sess.query(db_models.Image).filter(
        db_models.Image.id == db_image.uid)
    sql_image = q.one()
    q.delete()
    sess.commit()
...
def remove_image_from_experiment_group(experiment_group, image_uid: int, sess: Session):
    '''
...
def remove_result_layer_from_experiment_group(experiment_group, result_layer_uid: int, sess: Session):
    '''
...
def remove_measurement_from_experiment_group(experiment_group, measurement_uid: int, sess: Session):
    '''
...
def delete_classifier(clf, sess: Session):
    '''
...
def delete_experiment_result(experiment_result_uid: int, sess: Session):
    '''
...
def delete_experiment_group_by_id(experiment_group_uid: int, sess: Session):
    '''
...
def delete_experiment_by_id(experiment_uid: int, sess: Session):
    '''
